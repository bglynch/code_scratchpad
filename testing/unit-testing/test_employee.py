...
class TestEmployeeUsingSetupAndTearDown(unittest.TestCase):
    '''
    setUp: runs before every test
    tearDown: runs after every test
    
    as every test created the same employees, we can make code DRY by extracting that to setUp
    '''
    def setUp(self):
...
###### With Prints ######
class TestEmployeeUsingMocking(unittest.TestCase):
    
    # runs the the start of all the tests
    @classmethod
    def setUpClass(cls):
        print('setupClass')

    # runs the the end of all the tests
    @classmethod
